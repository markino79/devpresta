...
class AdminImportController extends AdminController
{
	...
	public function __construct()
	{
		...
		$this->match_ref = Tools::getValue('match_ref');
		...
		switch ((int)Tools::getValue('entity'))
		{
			...
			break;
			case $this->entities[$this->l('XML 100-one.it')]:
				$this->required_fields = array();
				$this->available_fields = array(
					'no' => array('label' => $this->l('Ignore this column')),
					'articolo-variante' => array('label' => $this->l('articolo-variante')),
					'articolo_x0020_codice_x0020_esterno' => array('label' => $this->l('articolo_x0020_codice_x0020_esterno')),
					'articolo' => array('label' => $this->l('articolo')),
					'variante' => array('label' => $this->l('variante')),
					'codice_x0020_fornitore' => array('label' => $this->l('codice_x0020_fornitore')),
					'fornitore' => array('label' => $this->l('fornitore')),
					'Tipo_x0020_Sigla' => array('label' => $this->l('Tipo_x0020_Sigla')),
					'Tipo_x0020_Descrizione' => array('label' => $this->l('Tipo_x0020_Descrizione')),
					'Reparto_x0020_Sigla' => array('label' => $this->l('Reparto_x0020_Sigla')),
					'Reparto_x0020_Descrizione' => array('label' => $this->l('Reparto_x0020_Descrizione')),
					'Sottoreparto_x0020_Sigla' => array('label' => $this->l('Sottoreparto_x0020_Sigla')),
					'Sottoreparto_x0020_Descrizione' => array('label' => $this->l('Sottoreparto_x0020_Descrizione')),
					'Categoria_x0020_Sigla' => array('label' => $this->l('Categoria_x0020_Sigla')),
					'Categoria_x0020_Descrizione' => array('label' => $this->l('Categoria_x0020_Descrizione')),
					'Marchio_x0020_Sigla' => array('label' => $this->l('Marchio_x0020_Sigla')),
					'Marchio_x0020_Descrizione' => array('label' => $this->l('Marchio_x0020_Descrizione')),
					'OLD_x0020_Sigla' => array('label' => $this->l('OLD_x0020_Sigla')),
					'OLD_x0020_Descrizione' => array('label' => $this->l('OLD_x0020_Descrizione')),
					'tg1' => array('label' => $this->l('tg1')),
					'tg2' => array('label' => $this->l('tg2')),
					'tg3' => array('label' => $this->l('tg1')),
					'tg4' => array('label' => $this->l('tg2')),
					'tg5' => array('label' => $this->l('tg5')),
					'tg6' => array('label' => $this->l('tg6')),
					'tg7' => array('label' => $this->l('tg7')),
					'tg8' => array('label' => $this->l('tg2')),
					'tg9' => array('label' => $this->l('tg8')),
					'tg10' => array('label' => $this->l('tg10')),
					'tg11' => array('label' => $this->l('tg11')),
					'tg12' => array('label' => $this->l('tg12')),
					'tg13' => array('label' => $this->l('tg13')),
					'tg14' => array('label' => $this->l('tg14')),
					'tg15' => array('label' => $this->l('tg15')),
					'tg16' => array('label' => $this->l('tg16')),
					'tg17' => array('label' => $this->l('tg17')),
					'tg18' => array('label' => $this->l('tg18')),
					'tg19' => array('label' => $this->l('tg19')),
					'tg20' => array('label' => $this->l('tg20')),
					'tg21' => array('label' => $this->l('tg21')),
					'tg22' => array('label' => $this->l('tg22')),
					'tg23' => array('label' => $this->l('tg23')),
					'tg24' => array('label' => $this->l('tg24')),
					'tg25' => array('label' => $this->l('tg25')),
					'tg26' => array('label' => $this->l('tg26')),
					'tg27' => array('label' => $this->l('tg27')),
					'tg28' => array('label' => $this->l('tg28')),
					'tg29' => array('label' => $this->l('tg29')),
					'tg30' => array('label' => $this->l('tg30')),
					'giacenza_x0020_tg1' => array('label' => $this->l('giacenza_x0020_tg1')),
					'giacenza_x0020_tg2' => array('label' => $this->l('giacenza_x0020_tg2')),
					'giacenza_x0020_tg3' => array('label' => $this->l('giacenza_x0020_tg3')),
					'giacenza_x0020_tg4' => array('label' => $this->l('giacenza_x0020_tg2')),
					'giacenza_x0020_tg5' => array('label' => $this->l('giacenza_x0020_tg5')),
					'giacenza_x0020_tg6' => array('label' => $this->l('giacenza_x0020_tg6')),
					'giacenza_x0020_tg7' => array('label' => $this->l('giacenza_x0020_tg7')),
					'giacenza_x0020_tg8' => array('label' => $this->l('giacenza_x0020_tg2')),
					'giacenza_x0020_tg9' => array('label' => $this->l('giacenza_x0020_tg8')),
					'giacenza_x0020_tg10' => array('label' => $this->l('giacenza_x0020_tg10')),
					'giacenza_x0020_tg11' => array('label' => $this->l('giacenza_x0020_tg11')),
					'giacenza_x0020_tg12' => array('label' => $this->l('giacenza_x0020_tg12')),
					'giacenza_x0020_tg13' => array('label' => $this->l('giacenza_x0020_tg13')),
					'giacenza_x0020_tg14' => array('label' => $this->l('giacenza_x0020_tg14')),
					'giacenza_x0020_tg15' => array('label' => $this->l('giacenza_x0020_tg15')),
					'giacenza_x0020_tg16' => array('label' => $this->l('giacenza_x0020_tg16')),
					'giacenza_x0020_tg17' => array('label' => $this->l('giacenza_x0020_tg17')),
					'giacenza_x0020_tg18' => array('label' => $this->l('giacenza_x0020_tg18')),
					'giacenza_x0020_tg19' => array('label' => $this->l('giacenza_x0020_tg19')),
					'giacenza_x0020_tg20' => array('label' => $this->l('giacenza_x0020_tg20')),
					'giacenza_x0020_tg21' => array('label' => $this->l('giacenza_x0020_tg21')),
					'giacenza_x0020_tg22' => array('label' => $this->l('giacenza_x0020_tg22')),
					'giacenza_x0020_tg23' => array('label' => $this->l('giacenza_x0020_tg23')),
					'giacenza_x0020_tg24' => array('label' => $this->l('giacenza_x0020_tg24')),
					'giacenza_x0020_tg25' => array('label' => $this->l('giacenza_x0020_tg25')),
					'giacenza_x0020_tg26' => array('label' => $this->l('giacenza_x0020_tg26')),
					'giacenza_x0020_tg27' => array('label' => $this->l('giacenza_x0020_tg27')),
					'giacenza_x0020_tg28' => array('label' => $this->l('giacenza_x0020_tg28')),
					'giacenza_x0020_tg29' => array('label' => $this->l('giacenza_x0020_tg29')),
					'giacenza_x0020_tg30' => array('label' => $this->l('giacenza_x0020_tg30')),
					'prezzo_x0020_vendita_x0020_tg1' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg1')),
					'prezzo_x0020_vendita_x0020_tg2' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg2')),
					'prezzo_x0020_vendita_x0020_tg3' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg1')),
					'prezzo_x0020_vendita_x0020_tg4' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg2')),
					'prezzo_x0020_vendita_x0020_tg5' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg5')),
					'prezzo_x0020_vendita_x0020_tg6' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg6')),
					'prezzo_x0020_vendita_x0020_tg7' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg7')),
					'prezzo_x0020_vendita_x0020_tg8' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg2')),
					'prezzo_x0020_vendita_x0020_tg9' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg8')),
					'prezzo_x0020_vendita_x0020_tg10' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg10')),
					'prezzo_x0020_vendita_x0020_tg11' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg11')),
					'prezzo_x0020_vendita_x0020_tg12' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg12')),
					'prezzo_x0020_vendita_x0020_tg13' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg13')),
					'prezzo_x0020_vendita_x0020_tg14' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg14')),
					'prezzo_x0020_vendita_x0020_tg15' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg15')),
					'prezzo_x0020_vendita_x0020_tg16' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg16')),
					'prezzo_x0020_vendita_x0020_tg17' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg17')),
					'prezzo_x0020_vendita_x0020_tg18' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg18')),
					'prezzo_x0020_vendita_x0020_tg19' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg19')),
					'prezzo_x0020_vendita_x0020_tg20' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg20')),
					'prezzo_x0020_vendita_x0020_tg21' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg21')),
					'prezzo_x0020_vendita_x0020_tg22' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg22')),
					'prezzo_x0020_vendita_x0020_tg23' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg23')),
					'prezzo_x0020_vendita_x0020_tg24' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg24')),
					'prezzo_x0020_vendita_x0020_tg25' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg25')),
					'prezzo_x0020_vendita_x0020_tg26' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg26')),
					'prezzo_x0020_vendita_x0020_tg27' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg27')),
					'prezzo_x0020_vendita_x0020_tg28' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg28')),
					'prezzo_x0020_vendita_x0020_tg29' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg29')),
					'prezzo_x0020_vendita_x0020_tg30' => array('label' => $this->l('prezzo_x0020_vendita_x0020_tg30')),
					'tab_x0020_stagione_x0020_sigla' => array('label' => $this->l('tab_x0020_stagione_x0020_sigla')),
					'tab_x0020_stagione_x0020_descrizione' => array('label' => $this->l('tab_x0020_stagione_x0020_descrizione')),
					'prezzo2_x0020_vendita_x0020_tg1' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg1')),
					'prezzo2_x0020_vendita_x0020_tg2' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg2')),
					'prezzo2_x0020_vendita_x0020_tg3' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg1')),
					'prezzo2_x0020_vendita_x0020_tg4' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg2')),
					'prezzo2_x0020_vendita_x0020_tg5' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg5')),
					'prezzo2_x0020_vendita_x0020_tg6' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg6')),
					'prezzo2_x0020_vendita_x0020_tg7' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg7')),
					'prezzo2_x0020_vendita_x0020_tg8' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg2')),
					'prezzo2_x0020_vendita_x0020_tg9' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg8')),
					'prezzo2_x0020_vendita_x0020_tg10' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg10')),
					'prezzo2_x0020_vendita_x0020_tg11' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg11')),
					'prezzo2_x0020_vendita_x0020_tg12' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg12')),
					'prezzo2_x0020_vendita_x0020_tg13' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg13')),
					'prezzo2_x0020_vendita_x0020_tg14' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg14')),
					'prezzo2_x0020_vendita_x0020_tg15' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg15')),
					'prezzo2_x0020_vendita_x0020_tg16' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg16')),
					'prezzo2_x0020_vendita_x0020_tg17' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg17')),
					'prezzo2_x0020_vendita_x0020_tg18' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg18')),
					'prezzo2_x0020_vendita_x0020_tg19' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg19')),
					'prezzo2_x0020_vendita_x0020_tg20' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg20')),
					'prezzo2_x0020_vendita_x0020_tg21' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg21')),
					'prezzo2_x0020_vendita_x0020_tg22' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg22')),
					'prezzo2_x0020_vendita_x0020_tg23' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg23')),
					'prezzo2_x0020_vendita_x0020_tg24' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg24')),
					'prezzo2_x0020_vendita_x0020_tg25' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg25')),
					'prezzo2_x0020_vendita_x0020_tg26' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg26')),
					'prezzo2_x0020_vendita_x0020_tg27' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg27')),
					'prezzo2_x0020_vendita_x0020_tg28' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg28')),
					'prezzo2_x0020_vendita_x0020_tg29' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg29')),
					'prezzo2_x0020_vendita_x0020_tg30' => array('label' => $this->l('prezzo2_x0020_vendita_x0020_tg30')),
					'articolo_x0020_descrizione2' => array('label' => $this->l('articolo_x0020_descrizione2')),
					'tab_x0020_tipo_x0020_taglia_x0020_sigla' => array('label' => $this->l('tab_x0020_tipo_x0020_taglia_x0020_sigla')),
					'nogozio_x0020_sigla' => array('label' => $this->l('nogozio_x0020_sigla')),
					'nogozio_x0020_descrizione' => array('label' => $this->l('nogozio_x0020_descrizione')),
					'articolo_x0020_note' => array('label' => $this->l('articolo_x0020_note')),
					'tab_x0020_tipo_x0020_taglia_x0020_descrizione' => array('label' => $this->l('tab_x0020_tipo_x0020_taglia_x0020_descrizione')),
				);
			self::$default_values = array();
			break;
			// @since 1.5.0
	...
	*/
	...
	public function categoryImport()
	{
		...
		for ($current_line = 0; $line = fgetcsv($handle, MAX_LINE_SIZE, $this->separator); $current_line++)
		{
			...
			$this->_inCategory($info,$default_language_id);
	...
	public function productImport()
	{
		...
		for ($current_line = 0; $line = fgetcsv($handle, MAX_LINE_SIZE, $this->separator); $current_line++)
		{
			...
			$this->_inProduct($info, $default_language_id, $shop_ids );
	...
	public function attributeImport()
	{
		...
		for ($current_line = 0; $line = fgetcsv($handle, MAX_LINE_SIZE, $this->separator); $current_line++)
		{
			...
			$this->_inAttribute($info, $groups, $attributes,$default_language);
		}
	...
	public function Xml100OneImport(){

		$default_language_id = (int)Configuration::get('PS_LANG_DEFAULT');
		$groups = array();
		foreach (AttributeGroup::getAttributesGroups($default_language_id) as $group)
			$groups[$group['name']] = (int)$group['id_attribute_group'];

		$attributes = array();
		foreach (Attribute::getAttributes($default_language_id) as $attribute)
			$attributes[$attribute['attribute_group'].'_'.$attribute['name']] = (int)$attribute['id_attribute'];
		...
		for ($current_line = 0; $line = fgetcsv($handle, MAX_LINE_SIZE, $this->separator); ++$current_line){
			...
			$id_category = $this->_inCategory(
				array(
					'active' => 1,
					'name' => $this->utf8Encode($info['Categoria_x0020_Descrizione']),
					'is_root_category' => 0,
					'description' => $this->utf8Encode($info['Categoria_x0020_Descrizione']),
					'parent' => (int)Context::getContext()->shop->id_category,
				),
				$default_language_id
			);
			/// Importa prodotti
			$produc_id = $this->_inProduct(
				array(
					...
					'supplier_reference' => $this->utf8Encode($info['articolo_x0020_codice_x0020_esterno']),
					'supplier' => $this->utf8Encode($info['fornitore']),
					'manufacturer' => $this->utf8Encode($info['Marchio_x0020_Descrizione']),
			...
			/// importa combinazioni di prodotti
			for ($x =1 ; $x <= 30; $x++){
				if (isset($info["tg$x"]) && !empty($info["tg$x"]) && 
					!empty($info["prezzo_x0020_vendita_x0020_tg$x"]) && 
					isset($info["prezzo_x0020_vendita_x0020_tg$x"])){
					$this->_inAttribute(
						array(
							'id_product' => $produc_id,
							'group' => 'taglia:select:0',
	...
	protected function _inCategory($info, $default_language_id){
...
// 			);
	...
	protected function _inManufactorer($info){
		...
		else
		{
			...
			if (array_key_exists('id', $info) && (int)$info['id'] && Manufacturer::existsInDatabase((int)$info['id'], 'manufacturer'))
				...
				if ($manufacturer_id = Manufacturer::getIdByName($info['name']))
	...
	protected function _inProduct($info, $default_language_id, $shop_ids){
		if (Tools::getValue('forceIDs') && isset($info['id']) && (int)$info['id'])
	...
	public function utf8Encode($s){
		$s = trim($s);
		mb_detect_order("windows-1251,windows-1258,UTF-8,ISO-8859-15,ISO-8859-1") ;
	...
	{
		$entity = (int)Tools::getValue('entity');
		if ( $entity == $this->entities[$this->l('XML 100-one.it')])
			$handle = $this->openXmlFile();
		else
	...
	protected function openXmlFile(){
		$handle = tmpfile();
		$xmlstr = file_get_contents(_PS_ADMIN_DIR_.'/import/'.strval(preg_replace('/\.{2,}/', '.', Tools::getValue('csv'))));
		$articoli = new SimpleXMLElement($xmlstr);
// 		echo "<pre>";
		$n = 0;
		foreach ($articoli->children() as $articolo) {
			$n++;
			$a = array();
			foreach ($articolo as $k=>$v){
				$a[$k] = $this->utf8Encode("".$v);
			}
// 			print_r($a);
			fputcsv($handle,$a,$this->separator);
// 			echo implode(',',$a) ."\n";
// 			echo $artocolo->{'articolo-variante'}. "\n";
		}
// 		echo $n;
// 		exit;
		rewind($handle);
