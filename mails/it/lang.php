...
$_LANGMAIL['Message from contact form\').\' [no_sync]'] = 'Messaggio dal form di contatto\').\'(no_sync)';
$_LANGMAIL['New credit slip regarding your order'] = 'Nuova nota di credito realtiva al tuo ordine';
$_LANGMAIL['Virtual product to download'] = 'Prodotto virtuale da scaricare';
$_LANGMAIL['Fwd: Customer message'] = 'I: Messaggio cliente';
