...
{else}
	...
	<form name="ContactForm" action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std" enctype="multipart/form-data" onsubmit="return checkPrivacyContactForm();">
		<fieldset>
		...
		<p class="contact_privacy_content">
